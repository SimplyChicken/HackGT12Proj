...
// (Optional) Floating examples – currently unused, kept for later
...
// Sanitize code before injecting into iframe (keep logs for debugging)
...
const DynamicCardPreview = ({ code }: { code: string }) => {
    ...
    useEffect(() => {
        try {
            ...
            // Fallback ensures <Card /> exists even if the code forgot to define it
            const ensureCardFallback = `
        if (typeof Card === 'undefined') {
          function Card() {
            return React.createElement(
              'div',
              { className: 'bg-white shadow rounded-lg p-6 max-w-sm' },
              React.createElement('h3', { className: 'text-lg font-medium text-gray-900 mb-2' }, 'Card Title'),
              React.createElement('p', { className: 'text-gray-600 mb-4' }, 'This is a simple fallback card.'),
              React.createElement(
                'button',
...
function CardCustomizerContent() {
  ...
  return (
    ...
    const getCurrentCode = () => (customizedCode ? customizedCode : defaultCardCode);
        ...
        try {
            ...
            const response = await fetch('/api/mastra', {
                ...
                body: JSON.stringify({
                    ...
                    data: { baseCode, userInput: customizationInput, preferences: {}, componentType: 'card' },
                }),
            });
        ...
        <div className="min-h-screen bg-eggshell">
            ...
            <main className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
                <div className="text-center mb-12">
                    <h2 className="text-4xl font-bold text-space-cadet mb-4 font-poly">AI-Powered Card Customizer</h2>
                    ...
                    <div className="p-6">
                        {activeTab === 'preview' ? (
                            <div>
                                ...
                                <div
                                    className="h-[70vh] flex items-center justify-center p-2 bg-gradient-to-br from-gray-100 to-gray-200 rounded-lg overflow-hidden"
                                ...
                                >
                                    <div className="flex flex-col items-center">
                                        ...
                                        <div className="relative w-full max-w-xl bg-black rounded-2xl p-4 shadow-2xl">
                                            <div className="bg-gray-800 rounded-xl p-2">
                                                ...
                                                <div
                                                    ...
                                                    style={{ aspectRatio: '16/10', height: '280px', overflowX: 'hidden', overflowY: 'auto' }}
                                                >
                                        ...
                                        <div className="flex flex-col items-center -mt-1">
                                            <div className="w-16 h-8 bg-gradient-to-b from-gray-700 to-gray-800 rounded-t-lg shadow-lg" />
                                            <div className="w-3 h-12 bg-gradient-to-b from-gray-600 to-gray-700 shadow-lg" />
                                            <div className="w-32 h-4 bg-gradient-to-r from-gray-500 via-gray-600 to-gray-500 rounded-lg shadow-xl" />
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div className="space-y-4">
                            <div>
                                <label
                                    ...
                                    className="block text-sm font-medium text-space-cadet mb-2 font-outfit"
                                >
                                ...
                                <textarea
                                    ...
                                    placeholder="e.g., add image thumbnail, rounded corners, shadow, and a CTA button..."
...
function LoadingFallback() {
    return (
        <div className="min-h-screen bg-gray-50">
            ...
            <main className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
                <div className="text-center mb-12">
                    <h2 className="text-3xl font-bold text-gray-900 mb-4">AI-Powered Card Customizer</h2>
