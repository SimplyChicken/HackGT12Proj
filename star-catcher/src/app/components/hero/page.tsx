...
function HeroCustomizerContent() {
  ...
  const handleCustomize = async () => {
    ...
    setIsLoading(true);
    try {
      // Get the current hero code (starter or previously customized)
            ...
            <div className="space-y-4">
              <div>
                ...
                <textarea
                  ...
                  placeholder="e.g., Change the gradient colors, add an image background, make it more compact..."
