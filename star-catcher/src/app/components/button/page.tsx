...
// Simple Button Preview Component that renders the React code in an iframe
const DynamicButtonPreview = ({ code }: { code: string }) => {
  ...
  useEffect(() => {
    const createPreview = () => {
      try {
        console.log('🔍 Creating button preview with code:', code);
                  ...
                  <div className="flex flex-col items-center w-full">
                    ...
                    <div className="relative w-full max-w-2xl bg-black rounded-2xl p-3 shadow-2xl">
                      ...
                      <div className="bg-gray-800 rounded-xl p-1">
                        {/* Screen Content */}
                        <div className="bg-white rounded-lg shadow-inner" style={{ aspectRatio: '16/10', height: '400px', overflowY: 'auto', overflowX: 'hidden', width: '100%' }}>
                    ...
                    <div className="flex flex-col items-center -mt-1">
                      {/* Stand Neck */}
                      <div className="w-20 h-9 bg-gradient-to-b from-gray-700 to-gray-800 rounded-t-lg shadow-lg"></div>
                      {/* Stand Post */}
                      <div className="w-3.5 h-14 bg-gradient-to-b from-gray-600 to-gray-700 shadow-lg"></div>
                      {/* Stand Base */}
                      <div className="w-36 h-4 bg-gradient-to-r from-gray-500 via-gray-600 to-gray-500 rounded-lg shadow-xl"></div>
                    </div>
                  </div>
                </div>
              </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
            ...
            <div className="space-y-4">
              ...
              <FloatingExamples examples={[
                ...
                "Make it larger and rounded",
                "Add an icon and make it green",
                "Make it a ghost button with border"
              ]} />
            </div>
          </div>
        </div>
