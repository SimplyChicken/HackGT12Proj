...
// Floating examples component (kept for future use)
...
// Footer Preview Component that renders the React code in an iframe
    ...
    useEffect(() => {
        const createPreview = () => {
            try {
                ...
                // Fallback to define Footer if user code didn't
                const ensureFooterFallback = `
            ...
            function Footer() {
              return React.createElement(
                ...
                React.createElement(
                  ...
                  React.createElement('p', { className: 'text-sm text-gray-600' }, '© 2024 Your Company. All rights reserved.')
                )
              );
            }
          }
...
<body>
    ...
    <script type="text/babel" data-presets="custom-react">
        ...
        root.render(React.createElement('div', { className: 'footer-content' }, React.createElement(Footer)));
    </script>
</body>
</html>`;
...
function FooterCustomizerContent() {
  ...
  return (
    ...
    const getCurrentCode = () => (customizedCode ? customizedCode : defaultFooterCode);
                        ...
                        <div className="space-y-4">
                            <div>
                                ...
                                <textarea
                                    ...
                                    placeholder="e.g., add newsletter sign-up, social icons, dark background, 3 columns…"
